...
/**
 * Representa un Pokémon de tipo Roca.
 *
 * La clase `Roca` extiende la clase base `Pokemon` y define el comportamiento
 * específico de un Pokémon de tipo Roca, incluyendo su movimiento característico.
 */
public class Roca extends Pokemon {

    /**
     * Constructor para crear un Pokémon de tipo Roca.
     *
    ...
    /**
     * Realiza el movimiento característico de un Pokémon de tipo Roca.
     *
     * Este método sobrescribe el método `mover` de la clase base `Pokemon`
     * para proporcionar un comportamiento específico para los Pokémon de tipo Roca.
     *
