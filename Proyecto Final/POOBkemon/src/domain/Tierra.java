...
/**
 * Representa un Pokémon de tipo Tierra.
 *
 * La clase `Tierra` extiende la clase base `Pokemon` y define el comportamiento
 * específico de un Pokémon de tipo Tierra, incluyendo su movimiento característico.
 */
public class Tierra extends Pokemon {

    /**
     * Constructor para crear un Pokémon de tipo Tierra.
     *
     ...
     */
    public Tierra(String nombre, int ps, int ataque, int defensa, int velocidad, int ataqueEspecial, int defensaEspecial) {
        super(nombre, ps, ataque, defensa, velocidad, ataqueEspecial, defensaEspecial);
    }

    /**
     * Realiza el movimiento característico de un Pokémon de tipo Tierra.
     *
     * Este método sobrescribe el método `mover` de la clase base `Pokemon`
     * para proporcionar un comportamiento específico para los Pokémon de tipo Tierra.
     *
     * @return Una cadena que describe el movimiento característico del Pokémon.
     */
    @Override
    public String mover() {
        return nombre + " usa Terremoto!";
    }
}