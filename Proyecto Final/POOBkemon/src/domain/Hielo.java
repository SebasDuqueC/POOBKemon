 ...
 * de un Pokémon de tipo Hielo, incluyendo su movimiento característico.
 */
public class Hielo extends Pokemon {

    /**
     * Constructor para crear un Pokémon de tipo Hielo.
     *
    ...
    /**
     * Realiza el movimiento característico de un Pokémon de tipo Hielo.
     *
     * @return Un mensaje indicando que el Pokémon usa el movimiento "Rayo de Hielo".
     */
    @Override
    public String mover() {
