...
/**
 * Representa un Pokémon de tipo Psíquico.
 *
 * La clase `Psiquico` extiende la clase base `Pokemon` y define el comportamiento
 * específico de un Pokémon de tipo Psíquico, incluyendo su movimiento característico.
 */
public class Psiquico extends Pokemon {

    /**
     * Constructor para crear un Pokémon de tipo Psíquico.
     *
     ...
     */
    public Psiquico(String nombre, int ps, int ataque, int defensa, int velocidad, int ataqueEspecial, int defensaEspecial) {
        super(nombre, ps, ataque, defensa, velocidad, ataqueEspecial, defensaEspecial);
    }

    /**
     * Realiza el movimiento característico de un Pokémon de tipo Psíquico.
     *
     * Este método sobrescribe el método `mover` de la clase base `Pokemon`
     * para proporcionar un comportamiento específico para los Pokémon de tipo Psíquico.
     *
