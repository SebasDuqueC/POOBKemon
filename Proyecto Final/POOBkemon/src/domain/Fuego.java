 ...
 * de un Pokémon de tipo Fuego, incluyendo su movimiento característico.
 */
public class Fuego extends Pokemon {

    /**
     * Constructor para crear un Pokémon de tipo Fuego.
     *
    ...
    /**
     * Realiza el movimiento característico de un Pokémon de tipo Fuego.
     *
     * @return Un mensaje indicando que el Pokémon usa el movimiento "Lanzallamas".
     */
    @Override
    public String mover() {
