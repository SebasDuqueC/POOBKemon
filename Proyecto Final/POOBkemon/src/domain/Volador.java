...
/**
 * Representa un Pokémon de tipo Volador.
 *
 * La clase `Volador` extiende la clase base `Pokemon` y define el comportamiento
 * específico de un Pokémon de tipo Volador, incluyendo su movimiento característico.
 */
public class Volador extends Pokemon {

    /**
     * Constructor para crear un Pokémon de tipo Volador.
     *
    ...
    /**
     * Realiza el movimiento característico de un Pokémon de tipo Volador.
     *
     * Este método sobrescribe el método `mover` de la clase base `Pokemon`
     * para proporcionar un comportamiento específico para los Pokémon de tipo Volador.
     *
