...
/**
 * Clase Planta que representa un Pokémon de tipo Planta.
 *
 * Esta clase extiende la clase base `Pokemon` y define el comportamiento
 * específico de un Pokémon de tipo Planta. Incluye un método sobrescrito
 * para realizar un movimiento característico.
 */
public class Planta extends Pokemon {

    /**
     * Constructor para crear un Pokémon de tipo Planta.
     *
     ...
     */
    public Planta(String nombre, int ps, int ataque, int defensa, int velocidad, int ataqueEspecial, int defensaEspecial) {
        super(nombre, ps, ataque, defensa, velocidad, ataqueEspecial, defensaEspecial);
    }

    /**
     * Realiza el movimiento característico de un Pokémon de tipo Planta.
     *
     * Este método sobrescribe el comportamiento de la clase base `Pokemon`
     * para definir un movimiento específico del tipo Planta.
     *
     * @return Una cadena que describe el movimiento realizado por el Pokémon.
     */
    @Override
    public String mover() {
        return nombre + " usa Latigazo Cepa!";
    }
}